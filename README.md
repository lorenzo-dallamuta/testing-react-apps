<div>
  ...
  <p>
    ...
    This is a port of the original repo at <a href="https://github.com/kentcdodds/testing-react-apps">
      https://github.com/kentcdodds/testing-react-apps
    </a>, ported to Vitest in a Next app
  <p>
  <p>
    I created a new repo because the whole app was rewritten with Next.js, the 
    reason for that is that I wanted to port the examples to the environment on 
    which I expect my collegues will be working when I tell them I have a wonderful 
    repo full of unit test examples for them to check out 🤭
  </p>
...
This will start [Vitest](https://vitest.dev/) in watch mode. Read the output and
...
[issue]: https://github.com/lorenzo-dallamuta/testing-react-apps/issues/new
<!-- prettier-ignore-end -->
